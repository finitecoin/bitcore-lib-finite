...
var jsonProposal = {
  ...
  url:"http://www.finitecoin.org/proposal/first_proposal"
};
...
```javascript
proposal.url="http://finitecoin.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url="http://finitecoin.org/fixedUrl"
